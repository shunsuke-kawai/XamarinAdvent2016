...
using Xamarin.Forms;
using XamarinAdvent2016.Droid;

[assembly: Dependency(typeof(MobileEngagement_Droid))]
namespace XamarinAdvent2016.Droid
{
    public class MobileEngagement_Droid : IMobileEngagement
    {
        public MobileEngagement_Droid() { }
